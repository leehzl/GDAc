...
async function downloader_jd() {
    ...
    if (remoteContent.indexOf("jdPetShareCodes") > 0) {
        await download(
            "https://github.com/an0na/jd_scripts/raw/master/jdPetShareCodes.js",
            "./jdPetShareCodes.js",
            "京东萌宠"
        );
    }
    if (remoteContent.indexOf("jdPlantBeanShareCodes") > 0) {
        await download(
            "https://github.com/an0na/jd_scripts/raw/master/jdPlantBeanShareCodes.js",
    ...
    if (remoteContent.indexOf("jdSuperMarketShareCodes") > 0)
        await download(
            "https://github.com/an0na/jd_scripts/raw/master/jdSuperMarketShareCodes.js",
            "./jdSuperMarketShareCodes.js",
            "京小超互助码"
        );
    if (remoteContent.indexOf("jdFactoryShareCodes") > 0) {
        await download(
            "https://github.com/an0na/jd_scripts/raw/master/jdFactoryShareCodes.js",
    ...
    if (remoteContent.indexOf("jdDreamFactoryShareCodes") > 0) {
        await download(
            "https://github.com/an0na/jd_scripts/raw/master/jdDreamFactoryShareCodes.js",
    ...
    if (remoteContent.indexOf("new Env('京喜农场')") > 0) {
        await download(
            "https://github.com/an0na/jd_scripts/raw/master/jdJxncTokens.js",
            "./jdJxncTokens.js",
            "京喜农场Token"
        );
        await download(
            "https://github.com/an0na/jd_scripts/raw/master/jdJxncShareCodes.js",
            "./jdJxncShareCodes.js",
            "京喜农场分享码"
        );
        await download(
